...
<link href="${basePath }/css/action.css" rel="stylesheet" type="text/css" /><script type="text/javascript"
...
<script>
	...
	$(function() {
		...
		if (status != "") {
			$("#userStatus").find("option[value=" + status + "]").attr(
					"selected", true);
	...
	function showDetail(id, name) {
		window.localStorage.setItem("detailFrom","resourceAuditList");
	...
	function showAudit(id) {
		window.localStorage.setItem("auditFrom","resourceAuditList");
...
<div class="content-wrapper">
	 ...
	 <section class="content-header">
           <h1><a href="javascript:void(0)">管理</a>&gt;<a href="javascript:void(0)">资源审批</a></h1>
     </section>
      <section class="content">
		<div class="container theme-showcase" role="main" style="width:100%;height:740px;background-color:#ffffff">
			...
			<form name="auditForm" action="${basePath}/userManageAction/showAudit.action" method="post">
				...
				<!-- <input type="hidden" id="hideStatusCon" name="auditStatus" value="3" /> -->
				<input type="hidden" id="hideStatusCon" name="auditStatus" value="0" />
